        ...
        <section id="about" className="about">
            ...
            <div className="about-content">
                <div className="description-about-content">
                    ...
                    <p className="text-about">Bonjour, je suis Matthieu Simon, passioné par le développement web et particulièrement le développement front-end avec une spécialité en ReactJS.
