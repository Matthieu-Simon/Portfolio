        ...
        <section id="about" className="about">
            ...
            <div className="about-content">
                <div className="description-about-content">
                    ...
                    <p className="text-about">Bonjour, je suis Matthieu Simon, passioné par le développement web et particulièrement le développement front-end avec une spécialité en ReactJS.<br/>
                    ...
                    <p className="text-about">En plus de ma formation, je maintiens une veille concernant les dernières tendances et technologies du développement web. Je continue mon apprentissage autour de l'ecosystème JavaScript.</p>
